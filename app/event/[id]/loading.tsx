    ...
    <main className="bg-[#071018]">
      <div className="mx-auto w-full max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="mt-6 grid gap-8 lg:grid-cols-[1.15fr_0.85fr] lg:gap-12">
          <div className="aspect-[16/10] animate-pulse rounded-lg bg-white/[0.06]" />
          <div className="space-y-5 py-2">
            <div className="h-7 w-28 animate-pulse rounded bg-[#00c2d1]/15" />
            <div className="h-12 w-4/5 animate-pulse rounded bg-white/[0.06]" />
